...
CATALOG_VERSION = "manufacturing_menu_2026_04_18"
SEED_TAG = "manufacturing_menu_seed"
ADMIN_ROLE_CODES = ("entity.super_admin", "admin", "entity.admin")


MENU_SPECS = [
    {
        "code": "inventory.productionorder",
    ...
    {
        "code": "inventory.manufacturing_work_order_browser",
    ...
    {
        "code": "inventory.manufacturing_boms",
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0066_restore_core_module_permissions"),
    ]
