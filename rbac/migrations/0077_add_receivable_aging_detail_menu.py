...
CATALOG_VERSION = "receivables_aging_detail_2026_04_22"


MENU_SPEC = {
    "code": "reports.financial_hub.receivables_hub.receivable_aging_detail",
    "name": "Receivable Aging Detail",
    "parent_code": "reports.financial_hub.receivables_hub",
    "route_path": "/reports/receivables/receivable-aging-detail",
    "route_name": "receivable-aging-detail",
    "icon": "grid-3x3-gap",
    "sort_order": 13,
    "permission_code": "reports.financial_hub.receivables_hub.receivable_aging_detail.view",
}
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "is_system_menu": True,
            "metadata": {
                "seed": "receivable_aging_detail_menu",
                "catalog_version": CATALOG_VERSION,
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="receivable_aging_detail_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="receivable_aging_detail_menu", menu_code=MENU_SPEC["code"])
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "receivable_aging_detail_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0076_add_receivables_report_menus")]
