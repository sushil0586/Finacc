...
SEED_TAG = "capital_distribution_phase6_tax_policy_permissions"
CATALOG_VERSION = "capital_distribution_phase6_2026_09_11"
ROLE_CODES = ("entity.super_admin", "admin", "entity.admin")
PERMISSIONS = (
    ("capital_distribution.tax_policy.view", "View Appropriation Tax Policies", "tax_policy", "view"),
    ("capital_distribution.tax_policy.manage", "Manage Appropriation Tax Policies", "tax_policy", "manage"),
    ("capital_distribution.tax_policy.submit", "Submit Appropriation Tax Policies", "tax_policy", "submit"),
    ("capital_distribution.tax_policy.approve", "Approve Appropriation Tax Policies", "tax_policy", "approve"),
)
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0148_add_capital_distribution_posting_permissions")]
