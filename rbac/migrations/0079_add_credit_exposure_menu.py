...
CATALOG_VERSION = "credit_exposure_menu_2026_04_22"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/receivables/credit-exposure",
    "route_name": "credit-exposure",
    "icon": "shield-check",
    "sort_order": 15,
    "permission_code": "reports.financial_hub.receivables_hub.credit_exposure.view",
}
...
def forwards(apps, schema_editor):
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="credit_exposure_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="credit_exposure_menu", menu_code=MENU_SPEC["code"])
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "credit_exposure_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0078_add_overdue_customers_menu")]
