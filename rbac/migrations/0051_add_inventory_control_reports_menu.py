...
CATALOG_VERSION = "inventory_control_reports_menu_2026_04_12"


REPORT_SPECS = [
    {
        "menu_code": "reports.inventory.non_moving_stock",
        "name": "Non-Moving Stock",
        "route_path": "/reports/inventory/non-moving-stock",
        "route_name": "inventory-non-moving-stock",
        "icon": "hourglass-split",
        "sort_order": 9,
        "permission_code": "reports.inventory.non_moving_stock.view",
    },
    {
        "menu_code": "reports.inventory.reorder_status",
        "name": "Reorder Status",
        "route_path": "/reports/inventory/reorder-status",
        "route_name": "inventory-reorder-status",
        "icon": "arrow-repeat",
        "sort_order": 10,
        "permission_code": "reports.inventory.reorder_status.view",
    },
]
    ...
    for spec in REPORT_SPECS:
        menu, _ = Menu.objects.update_or_create(
            ...
            defaults={
                ...
                "is_system_menu": True,
                "metadata": {
                    "seed": "inventory_control_reports_menu",
        ...
        rows = [
            RolePermission(
                ...
                metadata={"seed": "inventory_control_reports_menu", "catalog_version": CATALOG_VERSION},
                isactive=True,
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0050_add_inventory_operational_reports_menu")]
