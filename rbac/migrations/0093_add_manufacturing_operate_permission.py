...
SEED_TAG = "manufacturing_operate_permission"
CATALOG_VERSION = "manufacturing_operate_2026_05_07"
ADMIN_ROLE_CODES = ("entity.super_admin", "admin", "entity.admin")
PERMISSION_CODE = "manufacturing.workorder.operate"
...
def forwards(apps, schema_editor):
    ...
    permission, _ = Permission.objects.update_or_create(
        ...
        defaults={
            "name": "Operate Manufacturing Work Order",
            "module": "manufacturing",
            "resource": "workorder",
            "action": "operate",
            "description": "Start, complete, and skip manufacturing operations.",
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0092_add_manufacturing_qc_approve_permission"),
    ]
