...
SCREEN_SPECS = [
    ...
    ("reports.accountsreceivableaging", "reports.financial", "AR Aging", "accountsreceivableaging", "accountsreceivableaging", 13, "hourglass"),
    ("reports.accountspayableaging", "reports.financial", "AP Aging", "accountspayableaging", "accountspayableaging", 14, "timer"),
