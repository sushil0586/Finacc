...
CATALOG_VERSION = "collections_history_menu_2026_04_22"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/receivables/collections-history",
    "route_name": "collections-history",
    "icon": "clock-history",
    "sort_order": 17,
    "permission_code": "reports.financial_hub.receivables_hub.collections_history.view",
...
def forwards(apps, schema_editor):
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="collections_history_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="collections_history_menu", menu_code=MENU_SPEC["code"])
    export_permission_id = _upsert_permission(Permission, MENU_SPEC["export_permission_code"], seed="collections_history_menu", menu_code=MENU_SPEC["code"])
    ...
    grant_permission_ids = [base_permission_id, permission_id, export_permission_id]
    existing_pairs = set(
        RolePermission.objects.filter(
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "collections_history_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0081_add_open_items_menu")]
