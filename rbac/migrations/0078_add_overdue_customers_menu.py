...
CATALOG_VERSION = "overdue_customers_menu_2026_04_22"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/receivables/overdue-customers",
    "route_name": "overdue-customers",
    "icon": "exclamation-triangle",
    "sort_order": 14,
    "permission_code": "reports.financial_hub.receivables_hub.overdue_customers.view",
}
...
def forwards(apps, schema_editor):
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="overdue_customers_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="overdue_customers_menu", menu_code=MENU_SPEC["code"])
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "overdue_customers_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0077_add_receivable_aging_detail_menu")]
