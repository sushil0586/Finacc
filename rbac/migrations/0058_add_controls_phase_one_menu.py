...
CATALOG_VERSION = "controls_phase_one_menu_2026_04_14"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/controls/phase-one",
    "route_name": "controls-phase-one",
    "icon": "sliders-horizontal",
    "sort_order": 9,
    "permission_code": "reports.financial_hub.controls_phase_one.view",
}
    ...
    for role_id in source_role_ids:
        ...
        inserts.append(
            RolePermission(
                ...
                metadata={"seed": "controls_phase_one_menu", "catalog_version": CATALOG_VERSION},
                isactive=True,
            )
        )
    if inserts:
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0057_add_financial_hub_reports")]
