...
SEED_TAG = "payroll_attendance_menus"
CATALOG_VERSION = "payroll_attendance_menus_2026_05_17"
ADMIN_ROLE_CODES = (
    "entity.super_admin",
    "admin",
    "entity.admin",
...
SCREEN_SPECS = (
    {
        "menu_code": "payroll.attendance-summaries",
        ...
        "permission_codes": (
            ...
            "payroll.attendance_summaries.create",
            "payroll.attendance_summaries.update",
            "payroll.attendance_summaries.delete",
        ),
    },
    {
        "menu_code": "payroll.attendance-adjustments",
        ...
        "permission_codes": (
            ...
            "payroll.attendance_adjustments.create",
            "payroll.attendance_adjustments.update",
            "payroll.attendance_adjustments.delete",
        ),
    },
)
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0120_add_payroll_runtime_readiness_menu")]
