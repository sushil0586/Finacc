...
CATALOG_VERSION = "inventory_slow_dead_stock_menu_2026_05_08"


REPORT_SPEC = {
    "menu_code": "reports.inventory.slow_moving_dead_stock",
    "name": "Slow Moving vs Dead Stock",
    "route_path": "/reports/inventory/slow-moving-dead-stock",
    "route_name": "inventory-slow-moving-dead-stock",
    "icon": "bar-chart-steps",
    "sort_order": 10,
    "permission_code": "reports.inventory.slow_moving_dead_stock.view",
}
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "is_system_menu": True,
            "metadata": {
                "seed": "inventory_slow_dead_stock_menu",
    ...
    permission, _ = Permission.objects.update_or_create(
        ...
        defaults={
            "name": "Reports Inventory Slow Moving Dead Stock View",
            "module": "reports",
            "resource": "inventory",
            "action": "view",
            "description": "Reports Inventory Slow Moving Dead Stock View",
    ...
    rows = [
        RolePermission(
            ...
            metadata={"seed": "inventory_slow_dead_stock_menu", "catalog_version": CATALOG_VERSION},
            isactive=True,
        )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0102_add_asset_location_custodian_report_menu")]
