...
CATALOG_VERSION = "posting_setup_menu_2026_04_15"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/controls/posting-setup",
    "route_name": "controls-posting-setup",
    "icon": "database-cog",
    "sort_order": 11,
    "permission_code": "reports.financial_hub.posting_setup.view",
}
    ...
    for role_id in source_role_ids:
        ...
        inserts.append(
            RolePermission(
                ...
                metadata={"seed": "posting_setup_menu", "catalog_version": CATALOG_VERSION},
                isactive=True,
            )
        )
    if inserts:
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0059_add_year_end_close_menu")]
