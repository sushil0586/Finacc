...
CATALOG_VERSION = "gst_exception_dashboard_menu_2026_05_08"


REPORT_SPEC = {
    "menu_code": "reports.gstexceptiondashboard",
    "name": "GST Exception Dashboard",
    "route_path": "/reports/compliance/gst-exception-dashboard",
    "route_name": "reports-compliance-gst-exception-dashboard",
    "icon": "shield-exclamation",
    "sort_order": 7,
    "permission_code": "reports.gst_exception_dashboard.view",
}
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "is_system_menu": True,
            "metadata": {
                "seed": "gst_exception_dashboard_menu",
    ...
    permission, _ = Permission.objects.update_or_create(
        ...
        defaults={
            "name": "Reports GST Exception Dashboard View",
            "module": "reports",
            "resource": "gst_exception_dashboard",
            "action": "view",
            "description": "View GST Exception Dashboard report.",
    ...
    rows = [
        RolePermission(
            ...
            metadata={"seed": "gst_exception_dashboard_menu", "catalog_version": CATALOG_VERSION},
            isactive=True,
        )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0105_add_gst_reconciliation_report_menu")]
