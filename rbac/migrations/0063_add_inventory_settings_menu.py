...
CATALOG_VERSION = "inventory_settings_menu_2026_04_17"


MENU_SPEC = {
    "menu_code": "reports.inventory.settings",
    "name": "Inventory Settings",
    "route_path": "/inventorysettings",
    "route_name": "inventorysettings",
    "icon": "gear",
    "sort_order": 6,
    ...
    for role_id in role_ids:
        ...
        rows.append(
            RolePermission(
                ...
                metadata={"seed": "inventory_settings_menu", "catalog_version": CATALOG_VERSION},
                isactive=True,
            )
        )
    if rows:
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0062_add_inventory_transfer_action_permissions")]
