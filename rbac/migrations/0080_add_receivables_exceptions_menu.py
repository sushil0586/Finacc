...
CATALOG_VERSION = "receivables_exceptions_menu_2026_04_22"


MENU_SPEC = {
    "code": "reports.financial_hub.receivables_hub.receivables_exception_report",
    "name": "Receivables Exceptions",
    "parent_code": "reports.financial_hub.receivables_hub",
    "route_path": "/reports/receivables/exceptions",
    "route_name": "receivables-exceptions",
    "icon": "alert-triangle",
    "sort_order": 20,
    "permission_code": "reports.financial_hub.receivables_hub.receivables_exception_report.view",
}
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "is_system_menu": True,
            "metadata": {
                "seed": "receivables_exceptions_menu",
                "catalog_version": CATALOG_VERSION,
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="receivables_exceptions_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="receivables_exceptions_menu", menu_code=MENU_SPEC["code"])
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "receivables_exceptions_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0079_add_credit_exposure_menu")]
