...
SEED_TAG = "tds_compliance_center_menu"
CATALOG_VERSION = "tds_compliance_center_menu_2026_06_28"


MENU_SPEC = {
    "code": "reports.financial_hub.tds_compliance_center",
    "name": "TDS Compliance Center",
    "parent_code": "reports.financial_hub",
    "route_path": "/reports/tds",
    "route_name": "reports-tds-compliance-center",
    "icon": "file-bar-chart-2",
    "sort_order": 12,
    "permission_code": "reports.financial_hub.tds_compliance_center.view",
}

BASE_PERMISSION_CODE = "reports.financial_hub.view"
LEGACY_PERMISSION_CODE = "reports.tds.view"
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "metadata": {
                ...
                "legacy_permission_code": LEGACY_PERMISSION_CODE,
            },
            "isactive": True,
        },
    )
    ...
    legacy_permission_id = _upsert_permission(Permission, LEGACY_PERMISSION_CODE, menu_code=MENU_SPEC["code"])

    for permission_id in (canonical_permission_id, legacy_permission_id):
    ...
    grant_permission_ids = [base_permission_id, canonical_permission_id, legacy_permission_id]
    existing_pairs = set(
        RolePermission.objects.filter(
...
def backwards(apps, schema_editor):
    ...
    cleanup_permission_codes = [BASE_PERMISSION_CODE, MENU_SPEC["permission_code"], LEGACY_PERMISSION_CODE]
    ...
    permission_codes = [MENU_SPEC["permission_code"], LEGACY_PERMISSION_CODE]
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0129_rbac_audit_runtime_indexes"),
    ]
