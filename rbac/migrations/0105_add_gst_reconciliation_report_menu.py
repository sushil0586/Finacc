...
CATALOG_VERSION = "gst_reconciliation_report_menu_2026_05_08"


REPORT_SPEC = {
    "menu_code": "reports.gstr1gstr3breconciliation",
    "name": "GSTR-1 vs GSTR-3B Reconciliation",
    "route_path": "/reports/compliance/gstr1-vs-gstr3b",
    "route_name": "reports-compliance-gstr1-vs-gstr3b",
    "icon": "git-compare",
    "sort_order": 6,
    "permission_code": "reports.gstr1_gstr3b_reconciliation.view",
}
...
def forwards(apps, schema_editor):
    ...
    menu, _ = Menu.objects.update_or_create(
        ...
        defaults={
            ...
            "is_system_menu": True,
            "metadata": {
                "seed": "gst_reconciliation_report_menu",
    ...
    permission, _ = Permission.objects.update_or_create(
        ...
        defaults={
            "name": "Reports GSTR1 GSTR3B Reconciliation View",
            "module": "reports",
            "resource": "gst_reconciliation",
            "action": "view",
            "description": "View GSTR-1 vs GSTR-3B Reconciliation report.",
    ...
    rows = [
        RolePermission(
            ...
            metadata={"seed": "gst_reconciliation_report_menu", "catalog_version": CATALOG_VERSION},
            isactive=True,
        )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0104_add_upcoming_payments_calendar_report_menu")]
