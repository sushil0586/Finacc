...
SEED_TAG = "tcs_compliance_center_menu"
CATALOG_VERSION = "tcs_compliance_center_menu_2026_06_29"


MENU_SPEC = {
    "code": "reports.financial_hub.tcs_compliance_center",
    "name": "TCS Compliance Center",
    "parent_code": "reports.financial_hub",
    "route_path": "/reports/tcs",
    "route_name": "reports-tcs-compliance-center",
    "icon": "journal-check",
    "sort_order": 14,
    "permission_code": "reports.financial_hub.tcs_compliance_center.view",
}
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0131_add_gst_tds_compliance_center_menu"),
    ]
