...
CATALOG_VERSION = "inventory_location_stock_menu_2026_04_12"


REPORT_SPECS = [
    {
        "menu_code": "reports.inventory.location_stock",
        "name": "Location Stock",
        "route_path": "/reports/inventory/location-stock",
        "route_name": "inventory-location-stock",
        "icon": "geo-alt",
        "sort_order": 11,
        "permission_code": "reports.inventory.location_stock.view",
    },
]
    ...
    for spec in REPORT_SPECS:
        menu, _ = Menu.objects.update_or_create(
            ...
            defaults={
                ...
                "is_system_menu": True,
                "metadata": {
                    "seed": "inventory_location_stock_menu",
        ...
        rows = [
            RolePermission(
                ...
                metadata={"seed": "inventory_location_stock_menu", "catalog_version": CATALOG_VERSION},
                isactive=True,
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0051_add_inventory_control_reports_menu")]
