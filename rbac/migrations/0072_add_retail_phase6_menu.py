...
CATALOG_VERSION = "retail_phase6_menu_2026_04_19"
SEED_TAG = "retail_phase6_menu_seed"
ADMIN_ROLE_CODES = ("entity.super_admin", "admin", "entity.admin")


MENU_SPECS = [
    {
        "code": "sales.retail_sale_entry",
        "name": "Retail Sale",
        "parent_code": "sales",
        "route_path": "/retail-sale-entry",
        "route_name": "retail-sale-entry",
        "icon": "scan-barcode",
        "sort_order": 2,
        "permission_code": "retail.ticket.view",
    },
]


PERMISSION_SPECS = [
    ("retail.ticket.view", "retail", "ticket", "view", "View Retail Ticket"),
    ("retail.ticket.create", "retail", "ticket", "create", "Create Retail Ticket"),
    ("retail.ticket.update", "retail", "ticket", "update", "Update Retail Ticket"),
    ("retail.ticket.hold", "retail", "ticket", "hold", "Hold Retail Ticket"),
]
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0071_fix_commerce_phase5_menu_parents"),
    ]
