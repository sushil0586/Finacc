...
CATALOG_VERSION = "open_items_menu_2026_04_22"
...
MENU_SPEC = {
    ...
    "route_path": "/reports/receivables/open-items",
    "route_name": "open-items",
    "icon": "file-earmark-text",
    "sort_order": 16,
    "permission_code": "reports.financial_hub.receivables_hub.open_items.view",
...
def forwards(apps, schema_editor):
    ...
    base_permission_id = _upsert_permission(Permission, BASE_PERMISSION_CODE, seed="open_items_menu", menu_code=MENU_SPEC["code"])
    permission_id = _upsert_permission(Permission, MENU_SPEC["permission_code"], seed="open_items_menu", menu_code=MENU_SPEC["code"])
    export_permission_id = _upsert_permission(Permission, MENU_SPEC["export_permission_code"], seed="open_items_menu", menu_code=MENU_SPEC["code"])
        ...
        for grant_permission_id in grant_permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "open_items_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0080_add_receivables_exceptions_menu")]
