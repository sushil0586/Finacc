...
SEED_TAG = "financial_hub_settings_menu"
CATALOG_VERSION = "financial_hub_settings_menu_2026_05_11"
ADMIN_ROLE_CODES = ("entity.super_admin", "admin", "entity.admin")

MENU_SPEC = {
    "code": "reports.financial_hub.settings",
    "name": "Report Settings",
    "route_path": "/reports/financial/settings",
    "route_name": "financial-hub-settings",
    "icon": "sliders-horizontal",
    "sort_order": 9,
    "permission_code": "reports.financial_hub.settings.view",
}
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("rbac", "0107_reconcile_asset_menu_paths_live"),
    ]
