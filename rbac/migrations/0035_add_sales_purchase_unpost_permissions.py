...
CATALOG_VERSION = "frontend_permission_catalog_2026_03_unpost"

PERMISSION_SPECS = [
    # Sales (reverse route is operational unpost)
    ("sales.invoice.unpost", "Unpost Sales Invoice", "sales", "invoice", "unpost"),
    ("sales.invoice.reverse", "Reverse Sales Invoice Posting", "sales", "invoice", "reverse"),
    # Purchase
    ("purchase.invoice.unpost", "Unpost Purchase Invoice", "purchase", "invoice", "unpost"),
]
...
class Migration(migrations.Migration):
    dependencies = [
        ("rbac", "0034_add_gstr1_report_menu"),
    ]
