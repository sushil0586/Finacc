...
CATALOG_VERSION = "financial_hub_menu_2026_04_14"
...
def forwards(apps, schema_editor):
    ...
    for spec in MENU_SPECS:
        ...
        permission_ids.append(_upsert_permission(Permission, spec["permission_code"], seed="financial_hub_menu", menu_code=spec["code"]))
        ...
        if export_code:
            export_permission_id = _upsert_permission(Permission, export_code, seed="financial_hub_menu", menu_code=spec["code"])
        ...
        for permission_id in permission_ids:
            ...
            inserts.append(
                RolePermission(
                    ...
                    metadata={"seed": "financial_hub_menu", "catalog_version": CATALOG_VERSION},
                    isactive=True,
                )
            )
    if inserts:
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0055_add_inventory_location_master_and_adjustment_browser_menu")]
