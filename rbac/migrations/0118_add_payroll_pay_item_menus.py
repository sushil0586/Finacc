...
SEED_TAG = "payroll_pay_item_menus"
CATALOG_VERSION = "payroll_pay_item_menus_2026_05_17"
ADMIN_ROLE_CODES = (
    "entity.super_admin",
    "admin",
    "entity.admin",
...
SCREEN_SPECS = (
    {
        "menu_code": "payroll.recurring-pay-items",
        ...
        "permission_codes": (
            ...
            "payroll.recurring_pay_items.create",
            "payroll.recurring_pay_items.update",
            "payroll.recurring_pay_items.delete",
        ),
    },
    {
        "menu_code": "payroll.one-time-pay-items",
        ...
        "permission_codes": (
            ...
            "payroll.one_time_pay_items.create",
            "payroll.one_time_pay_items.update",
            "payroll.one_time_pay_items.delete",
        ),
    },
)
...
class Migration(migrations.Migration):
    dependencies = [("rbac", "0117_add_payroll_policy_menus")]
