...
class ProductBarcodeManageSerializer(serializers.ModelSerializer):
    """
    Used for Barcode Management UI:
    - list by product
    - create new barcode (barcode value + image auto-generated by model)
    - update barcode (uom / pack_size / isprimary)
    """
    ...
    def create(self, validated_data):
        """
        product comes from context (endpoint: /products/<id>/barcodes/)
        barcode + barcode_image are auto-generated by ProductBarcode.save()
        """
