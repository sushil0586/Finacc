...
from purchase.views.purchase_invoice import (
    ...
    PurchaseServiceInvoiceSearchAPIView,
    PurchaseInvoiceLookupAPIView,
    PurchaseServiceInvoiceLookupAPIView,
    PurchaseInvoiceCrossModeNavigationAPIView,
    PurchaseServiceInvoiceCrossModeNavigationAPIView,
)
...
from purchase.views.purchase_meta import (
    ...
    PurchaseInvoiceVendorsMetaAPIView,
...
from purchase.views.purchase_statutory import (
    ...
    PurchaseStatutoryReturnReadinessSummaryAPIView,
    PurchaseStatutoryReturnQualitySummaryAPIView,
    ...
    PurchaseStatutoryItcStatusRegisterReviewAPIView,
    ...
    PurchaseStatutoryReturnForm16ACertificatesAPIView,
    PurchaseStatutoryReturnForm16ACertificateUploadAPIView,
    PurchaseStatutoryReturnForm16ACertificateDownloadAPIView,
...
urlpatterns = [
    ...
    path("statutory/returns/readiness-summary/", PurchaseStatutoryReturnReadinessSummaryAPIView.as_view(), name="purchase-statutory-return-readiness-summary"),
    path("statutory/returns/quality-summary/", PurchaseStatutoryReturnQualitySummaryAPIView.as_view(), name="purchase-statutory-return-quality-summary"),
    ...
    path("statutory/returns/<int:pk>/form16a-certificates/", PurchaseStatutoryReturnForm16ACertificatesAPIView.as_view(), name="purchase-statutory-return-form16a-certificates"),
    ...
    path("meta/vendors/", PurchaseInvoiceVendorsMetaAPIView.as_view(), name="purchase-invoice-vendors-meta"),
    ...
    path("purchase-invoices/<int:pk>/compliance/status/", PurchaseInvoiceComplianceStatusAPIView.as_view(), name="purchase-invoice-compliance-status"),
    path("purchase-service-invoices/search/", PurchaseServiceInvoiceSearchAPIView.as_view(), name="purchase-service-invoice-search"),
    ...
    path("purchase-service-invoices/<int:pk>/compliance/status/", PurchaseInvoiceComplianceStatusAPIView.as_view(), name="purchase-service-invoice-compliance-status"),
