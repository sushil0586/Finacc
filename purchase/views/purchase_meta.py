    ...
    def _invoice_action_flags(self, header: PurchaseInvoiceHeader):
        ...
        return build_document_action_flags(
            ...
            extra={
                ...
                "locked_correction_message": (
                    "This invoice is in a filed/locked period. Create a current-period correction draft instead of editing or unposting it."
                    if can_correct_locked_posted else None
                ),
            },
        )
    ...
    def get(self, request):
        ...
        payload = {
            ...
            "config": {
                ...
                "tds_194q_prev_fy_turnover": getattr(cfg, "tds_194q_prev_fy_turnover", None),
                "tds_194q_turnover_limit": getattr(cfg, "tds_194q_turnover_limit", None),
                "tds_194q_force_eligible": getattr(cfg, "tds_194q_force_eligible", None),
