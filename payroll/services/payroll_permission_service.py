...
class PayrollPermissionService:
    ENTITY_PERMISSION_CODES = {
        ...
        "attendance_adjustment_view": {"payroll.attendance_adjustments.view", "payroll.run.view", "payroll.run.manage"},
        "attendance_adjustment_create": {"payroll.attendance_adjustments.create", "payroll.run.manage"},
        "attendance_adjustment_edit": {"payroll.attendance_adjustments.update", "payroll.run.manage"},
        "attendance_adjustment_delete": {"payroll.attendance_adjustments.delete", "payroll.run.manage"},
        "attendance_summary_view": {"payroll.attendance_summaries.view", "payroll.run.view", "payroll.run.manage"},
        "attendance_summary_create": {"payroll.attendance_summaries.create", "payroll.run.manage"},
        "attendance_summary_edit": {"payroll.attendance_summaries.update", "payroll.run.manage"},
        "attendance_summary_delete": {"payroll.attendance_summaries.delete", "payroll.run.manage"},
