...
urlpatterns = [
    ...
    path("vouchers/<int:pk>/attachments/", VoucherAttachmentListCreateAPIView.as_view(), name="voucher-attachments"),
    path("vouchers/<int:pk>/attachments/<int:attachment_id>/", VoucherAttachmentDeleteAPIView.as_view(), name="voucher-attachment-delete"),
    path("vouchers/<int:pk>/attachments/<int:attachment_id>/download/", VoucherAttachmentDownloadAPIView.as_view(), name="voucher-attachment-download"),
