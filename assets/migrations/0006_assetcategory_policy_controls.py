        ...
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.RunSQL(
                    ...
                    DEFAULT '{"serial_number_rule":"inherit","manufacturer_rule":"inherit","model_number_rule":"inherit","vendor_account_rule":"inherit"}'::jsonb;
                    """,
                    reverse_sql="""
                ...
                migrations.RunSQL(
                    ...
                    DEFAULT '{"asset_ledger_rule":"inherit","depreciation_ledgers_rule":"inherit","impairment_ledgers_rule":"inherit","disposal_ledgers_rule":"inherit","cwip_ledger_rule":"inherit"}'::jsonb;
                    """,
                    reverse_sql="""
