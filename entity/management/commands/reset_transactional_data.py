...
class Command(BaseCommand):
    ...
    def _build_specs(self) -> list[CleanupSpec]:
        return [
            ...
            CleanupSpec(
                "Asset depreciation run lines",
                "assets",
                "DepreciationRunLine",
                entity_field="run__entity_id",
                entityfin_field="run__entityfinid_id",
                subentity_field="run__subentity_id",
            ),
            CleanupSpec("Asset depreciation runs", "assets", "DepreciationRun"),
            CleanupSpec("Fixed assets", "assets", "FixedAsset"),
