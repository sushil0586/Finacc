...
class SalesChargeTypeSerializer(serializers.ModelSerializer):
    ...
    hsn_sac_code_default = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=20)
    description = serializers.CharField(required=False, allow_blank=True, allow_null=True, max_length=200)
    ...
    def validate(self, attrs):
        ...
        gst_rate = Decimal(attrs.get("gst_rate_default", getattr(self.instance, "gst_rate_default", ZERO2)) or ZERO2)
        code = str(
