...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        summary = SalesSeedService.seed_choice_overrides(entity=ent, subentity=sub)

        self.stdout.write(
            self.style.SUCCESS(
                f"✅ SalesChoiceOverride seeding done | created={summary['created']}, updated={summary['updated']}"
            )
        )
