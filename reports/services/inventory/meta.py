...
def _report_registry() -> list[dict]:
    return [
        ...
        {
            'code': 'inventory_slow_moving_dead_stock',
            'name': 'Slow Moving vs Dead Stock',
            'path': '/api/reports/inventory/slow-moving-dead-stock/',
            'category': 'inventory',
            'required_permission': 'reports.inventory.slow_moving_dead_stock.view',
            'scope_modes': ['financial_year', 'month', 'quarter', 'year', 'custom', 'as_of'],
            'supports': {
                'entityfinid': True,
                'subentity': True,
