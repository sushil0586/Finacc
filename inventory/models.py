...
class Product(TrackingModel):
    ...
    openingstockvalue = models.DecimalField(max_digits=10, decimal_places=2,null=True,blank=True)
    ...
    cess = models.DecimalField(max_digits=10, decimal_places=2,default = 0,null=True)
