...
class gstorderservices(TrackingModel):
    ...
    expensesbeforetax =  models.DecimalField(max_digits=10, decimal_places=2,default=0,verbose_name= 'Expenses before tax')
    ...
    igstreverse =  models.DecimalField(max_digits=10, decimal_places=2,default=0,verbose_name= 'I.GST Reverse')
    cgstreverse =  models.DecimalField(max_digits=10, decimal_places=2,default=0,verbose_name= 'C.GST Reverse')
    sgstreverse =  models.DecimalField(max_digits=10, decimal_places=2,default=0,verbose_name= 'S.GST Reverse')
    ...
    expensesaftertax =  models.DecimalField(max_digits=10, decimal_places=2,default=0,verbose_name= 'Expenses after tax')
...
class gstorderservicesdetails(TrackingModel):
    ...
    amount =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'Amount',null = True)
    cgst =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'CGST',null = True)
    sgst =  models.DecimalField(max_digits=10,null = True,default = 1, decimal_places=2,verbose_name= 'SGST')
    igst =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'IGST',null = True)
    cgstreverse =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'CGST Reverse',null = True,default = 0)
    sgstreverse =  models.DecimalField(max_digits=10,null = True, decimal_places=2,verbose_name= 'SGST Reverse',default = 0)
    igstreverse =  models.DecimalField(max_digits=10, decimal_places=2,verbose_name= 'IGST Reverse',null = True,default = 0)
...
class StockTransactions(TrackingModel):
    ...
    quantity =  models.DecimalField(max_digits=10,null = True, decimal_places=2,verbose_name= 'quantity',blank=True)
    rate =  models.DecimalField(max_digits=10,null = True, decimal_places=2,verbose_name= 'Rate',blank=True)
    drcr = models.BooleanField(verbose_name='Debit/Credit',null = True)
    debitamount =  models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'Debit Amount',blank=True)
    creditamount =  models.DecimalField(max_digits=10,null = True, decimal_places=2,verbose_name= 'Credit Amount',blank=True)
    ...
    weightqty =  models.DecimalField(max_digits=10,null = True, decimal_places=2,verbose_name= 'Weight Quantity',blank=True)
...
class tdsmain(TrackingModel):
    ...
    amount = models.DecimalField(max_digits=10,decimal_places=2,verbose_name= 'Credit Amount',default=0)
    debitamount = models.DecimalField(max_digits=10,decimal_places=2,verbose_name= 'debit Amount',default=0)
    otherexpenses = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'other expenses',default=0)
    tdsrate = models.DecimalField(max_digits=10,decimal_places=2,verbose_name= 'tds rate',default=0)
    tdsvalue = models.DecimalField(max_digits=10,decimal_places=2,verbose_name= 'tds Value',default=0)
    surchargerate = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'Surcharge rate',default=0)
    surchargevalue = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'Surcharge Value',default=0)
    cessrate = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'Cess rate',default=0)
    cessvalue = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'Cess Value',default=0)
    hecessrate = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'HE Cess rate',default=0)
    hecessvalue = models.DecimalField(max_digits=10,null = True,decimal_places=2,verbose_name= 'HE Cess Value',default=0)
    grandtotal = models.DecimalField(max_digits=10,decimal_places=2,verbose_name= 'Grand Total',default=0)
    tdsreturndesc = models.CharField(max_length= 255,verbose_name= 'tds return Acc desc',null=True)
