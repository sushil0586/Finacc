...
class gstorderservices(TrackingModel):
    ...
    totalgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'totalgst')
    subtotal =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Sub Total')
    expensesbeforetax =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Expenses before tax')
    agent = models.CharField(max_length=50,verbose_name='Agent',null=True)
    cgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'C.GST')
    sgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'S.GST')
    igstreverse =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'I.GST Reverse')
    cgstreverse =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'C.GST Reverse')
    sgstreverse =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'S.GST Reverse')
    igst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'I.GST')
    multiplier = models.IntegerField(verbose_name='multiplier',default=0,blank = True)
    expensesaftertax =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Expenses after tax')
    gtotal =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Grand Total')
...
class gstorderservicesdetails(TrackingModel):
    ...
    # orderqty =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Order Qty')
    ...
    amount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Amount',null = True)
    cgst =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'CGST',null = True)
    sgst =  models.DecimalField(max_digits=10,null = True,default = 1, decimal_places=4,verbose_name= 'SGST')
    igst =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'IGST',null = True)
    cgstreverse =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'CGST Reverse',null = True,default = 0)
    sgstreverse =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'SGST Reverse',default = 0)
    igstreverse =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'IGST Reverse',null = True,default = 0)
...
class SalesOderHeader(TrackingModel):
    ...
    totalquanity =  models.DecimalField(max_digits=10, decimal_places=4,default=0 ,blank = True,verbose_name= 'totalquanity')
    advance =  models.DecimalField(max_digits=10, decimal_places=4,default=0 ,blank = True,verbose_name= 'advance')
    ...
    tds194q =  models.DecimalField(max_digits=10, decimal_places=4,default=0, verbose_name= 'TDS 194 @')
    tds194q1 =  models.DecimalField(max_digits=10, decimal_places=4,default=0, verbose_name= 'TDS 194 @')
    tcs206c1ch1 =  models.DecimalField(max_digits=10, decimal_places=4,default=0 ,verbose_name= 'Tcs 206C1cH1')
    tcs206c1ch2 =  models.DecimalField(max_digits=10, decimal_places=4,default=0, verbose_name= 'Tcs 206C1cH2')
    tcs206c1ch3 =  models.DecimalField(max_digits=10, decimal_places=4,default=0, verbose_name= 'Tcs tcs206c1ch3')
    tcs206C1 =  models.DecimalField(max_digits=10, decimal_places=4,default=0 ,verbose_name= 'Tcs 206C1')
    tcs206C2 =  models.DecimalField(max_digits=10, decimal_places=4,default=0 ,verbose_name= 'Tcs 206C2')
    duedate = models.DateField(verbose_name='Due Date',null = True)
    totalgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'totalgst')
    subtotal =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Sub Total')
    addless =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Add/Less')
    discount = models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Discount')
    cgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'C.GST')
    sgst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'S.GST')
    igst =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'I.GST')
    ...
    cess = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Cess',default=0)
    expenses =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'EXpenses')
    gtotal =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Grand Total')
    entity = models.ForeignKey(entity,on_delete=models.CASCADE,verbose_name= 'entity',null= True)
    entityfinid = models.ForeignKey(entityfinancialyear,on_delete=models.CASCADE,verbose_name= 'entity Financial year',null= True)
    owner = models.ForeignKey(to= User, on_delete= models.CASCADE,null=True)
...
class jobworkchalan(TrackingModel):
    ...
    subtotal = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Sub Total')
    cgst = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'C.GST',default=0)
    sgst = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'S.GST',default=0)
    igst = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'I.GST',default=0)
    addless =  models.DecimalField(max_digits=10, decimal_places=4,default=0,verbose_name= 'Add/Less')
    # cgstcess = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'C.GST Cess',default=0)
    # sgstcess = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'S.GST Cess',default=0)
    cess = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Cess',default=0)
    expenses = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Expenses',default=0)
    gtotal = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'G Total')
    entity = models.ForeignKey(entity,on_delete=models.CASCADE,verbose_name= 'entity')
    entityfinid = models.ForeignKey(entityfinancialyear,on_delete=models.CASCADE,verbose_name= 'entity Financial year',null= True)
    createdby = models.ForeignKey(to= User, on_delete= models.CASCADE,null=True)
...
class PurchaseOrderimportdetails(models.Model):
    ...
    pieces =  models.IntegerField(verbose_name='pieces')
    rate =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Rate')
    actualamount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Actual amount')
    importamount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Import Amount')
    igst =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'IGST')
    othercharges =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'other charges',default=0,null=True)
    cess = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Cess',default=0)
    linetotal =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Line Total')
...
class journaldetails(TrackingModel):
    ...
    debitamount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Debit Amount',null=True)
    creditamount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Credit Amount',null=True)
    discount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Discount',null=True,default=0)
    bankcharges =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Bank Charges',null=True,default=0)
    tds =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'tds',null=True,default=0)
...
class stockdetails(TrackingModel):
    ...
    issuedquantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Issued quantity')
    recivedquantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Received quantity')
    entity = models.ForeignKey(entity,on_delete=models.CASCADE,verbose_name= 'entity')
    createdby = models.ForeignKey(to= User, on_delete= models.CASCADE,null=True)
...
class productiondetails(TrackingModel):
    ...
    desc = models.CharField(max_length=500, null=True,verbose_name='Description')
    issuereceived = models.BooleanField(verbose_name='Issue/Receipt')
    quantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Issued quantity')
    rate =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Rate',null = True)
    entity = models.ForeignKey(entity,on_delete=models.CASCADE,verbose_name= 'entity')
    createdby = models.ForeignKey(to= User, on_delete= models.CASCADE,null=True)
...
class entry(TrackingModel):
    ...
    openingbalance =  models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Opening Amount')
    closingbalance =  models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'closing Amount')
...
class StockTransactions(TrackingModel):
    ...
    quantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'quantity',blank=True)
    rate =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Rate',blank=True)
    drcr = models.BooleanField(verbose_name='Debit/Credit',null = True)
    debitamount =  models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Debit Amount',blank=True)
    creditamount =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Credit Amount',blank=True)
    ...
    # subtotal =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Sub Total')
    pieces = models.IntegerField(verbose_name='Pieces',null=True,blank=True)
    weightqty =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Weight Quantity',blank=True)
...
class goodstransaction(TrackingModel):
    ...
    desc = models.CharField(max_length=500, null=True,verbose_name='Description')
    stockttype = models.CharField(verbose_name='Stock Transaction',max_length=10,null=True)
    salequantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Sale quantity')
    purchasequantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Purchase quantity')
    issuedquantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Issued quantity')
    recivedquantity =  models.DecimalField(max_digits=10,null = True, decimal_places=4,verbose_name= 'Received quantity')
...
class tdsmain(TrackingModel):
    ...
    amount = models.DecimalField(max_digits=10,decimal_places=4,verbose_name= 'Credit Amount',default=0)
    debitamount = models.DecimalField(max_digits=10,decimal_places=4,verbose_name= 'debit Amount',default=0)
    otherexpenses = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'other expenses',default=0)
    tdsrate = models.DecimalField(max_digits=10,decimal_places=4,verbose_name= 'tds rate',default=0)
    tdsvalue = models.DecimalField(max_digits=10,decimal_places=4,verbose_name= 'tds Value',default=0)
    surchargerate = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Surcharge rate',default=0)
    surchargevalue = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Surcharge Value',default=0)
    cessrate = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Cess rate',default=0)
    cessvalue = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'Cess Value',default=0)
    hecessrate = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'HE Cess rate',default=0)
    hecessvalue = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'HE Cess Value',default=0)
    grandtotal = models.DecimalField(max_digits=10,decimal_places=4,verbose_name= 'Grand Total',default=0)
    tdsreturndesc = models.CharField(max_length= 255,verbose_name= 'tds return Acc desc',null=True)
    ...
    weight = models.DecimalField(max_digits=10,null = True,decimal_places=4,verbose_name= 'weight')
...
class debitcreditnote(TrackingModel):
    ...
    rate =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Rate')
    basicvalue =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Amount')
    cndnamount =  models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Credit/Debit Note')
...
class closingstock(TrackingModel):
    ...
    closingrate = models.DecimalField(max_digits=10, decimal_places=4,verbose_name= 'Closing Rate')
    entity = models.ForeignKey(entity,on_delete=models.CASCADE,verbose_name= 'entity')
    createdby = models.ForeignKey(to= User, on_delete= models.CASCADE,null=True)
