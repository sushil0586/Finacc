...
SECURE_HSTS_INCLUDE_SUBDOMAINS = config('SECURE_HSTS_INCLUDE_SUBDOMAINS', default=False, cast=_cast_boolish_env)
SECURE_HSTS_PRELOAD = config('SECURE_HSTS_PRELOAD', default=False, cast=_cast_boolish_env)
...
WHITEBOOKS_SANDBOX_MODE = config('WHITEBOOKS_SANDBOX_MODE', default=True, cast=_cast_boolish_env)
WHITEBOOKS_API_KEY = config('WHITEBOOKS_API_KEY', default=config('WHITEBOX_GST_CLIENT_ID', default=''))
WHITEBOOKS_API_SECRET = config('WHITEBOOKS_API_SECRET', default=config('WHITEBOX_GST_CLIENT_SECRET', default=''))
WHITEBOOKS_CONTACT_EMAIL = config('WHITEBOOKS_CONTACT_EMAIL', default=config('WHITEBOX_GST_CONTACT_EMAIL', default=''))
WHITEBOOKS_GST_USERNAME = config('WHITEBOOKS_GST_USERNAME', default=config('WHITEBOX_GST_USERNAME', default=''))
...
WHITEBOOKS_ENABLE_GSTR3B_OFFSET_LIVE = config('WHITEBOOKS_ENABLE_GSTR3B_OFFSET_LIVE', default=False, cast=_cast_boolish_env)
WHITEBOOKS_ENABLE_GSTR3B_FILE_LIVE = config('WHITEBOOKS_ENABLE_GSTR3B_FILE_LIVE', default=False, cast=_cast_boolish_env)

# Backward-compatible aliases for the first Finacc GST portal adapter naming.
WHITEBOX_GST_BASE_URL = config('WHITEBOX_GST_BASE_URL', default=WHITEBOOKS_BASE_URL)
WHITEBOX_GST_CLIENT_ID = config('WHITEBOX_GST_CLIENT_ID', default=WHITEBOOKS_API_KEY)
WHITEBOX_GST_CLIENT_SECRET = config('WHITEBOX_GST_CLIENT_SECRET', default=WHITEBOOKS_API_SECRET)
WHITEBOX_GST_CONTACT_EMAIL = config('WHITEBOX_GST_CONTACT_EMAIL', default=WHITEBOOKS_CONTACT_EMAIL)
WHITEBOX_GST_USERNAME = config('WHITEBOX_GST_USERNAME', default=WHITEBOOKS_GST_USERNAME)
WHITEBOX_GST_STATE_CODE = config('WHITEBOX_GST_STATE_CODE', default=WHITEBOOKS_STATE_CODE)
WHITEBOX_GST_IP_ADDRESS = config('WHITEBOX_GST_IP_ADDRESS', default=WHITEBOOKS_IP_ADDRESS)
WHITEBOX_GST_TIMEOUT_SECONDS = WHITEBOOKS_TIMEOUT_SECONDS
