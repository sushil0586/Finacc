...
STATIC_ACCOUNT_MASTER_DEFS: Tuple[StaticAccountSeedDef, ...] = (
    ...
    StaticAccountSeedDef("PAYROLL_SALARY_PAYABLE", "Payroll Salary Payable", StaticAccountGroup.OTHER, "Default salary payable ledger for payroll posting when entity policy mapping is not configured.", True),
    StaticAccountSeedDef("PAYROLL_REIMBURSEMENT_PAYABLE", "Payroll Reimbursement Payable", StaticAccountGroup.OTHER, "Default reimbursement payable ledger for payroll posting when entity policy mapping is not configured.", False),
    StaticAccountSeedDef("PAYROLL_EMPLOYER_CONTRIBUTION_PAYABLE", "Payroll Employer Contribution Payable", StaticAccountGroup.OTHER, "Default employer contribution payable ledger for payroll posting when component-level liability mapping is not configured.", False),
    StaticAccountSeedDef("PAYROLL_PF_PAYABLE", "Payroll PF Payable", StaticAccountGroup.OTHER, "Default provident-fund payable ledger for payroll and FnF statutory posting.", False),
    StaticAccountSeedDef("PAYROLL_ESI_PAYABLE", "Payroll ESI Payable", StaticAccountGroup.OTHER, "Default ESI payable ledger for payroll and FnF statutory posting.", False),
    StaticAccountSeedDef("PAYROLL_PT_PAYABLE", "Payroll PT Payable", StaticAccountGroup.OTHER, "Default professional-tax payable ledger for payroll and FnF statutory posting.", False),
    StaticAccountSeedDef("PAYROLL_LWF_PAYABLE", "Payroll LWF Payable", StaticAccountGroup.OTHER, "Default labour-welfare-fund payable ledger for payroll and FnF statutory posting.", False),
    StaticAccountSeedDef("PAYROLL_FNF_PAYABLE", "Payroll FnF Payable", StaticAccountGroup.OTHER, "Default final-settlement payable ledger for FnF posting.", False),
    StaticAccountSeedDef("PAYROLL_FNF_RECOVERABLE", "Payroll FnF Recoverable", StaticAccountGroup.OTHER, "Default final-settlement recoverable ledger for FnF posting.", False),
