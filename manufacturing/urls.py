...
from .views import (
    ...
    ManufacturingMaterialConsumptionAPIView,
    ManufacturingOutputYieldAPIView,
    ManufacturingPostingAuditAPIView,
    ManufacturingRouteDetailAPIView,
    ManufacturingRouteListCreateAPIView,
    ManufacturingSummaryAPIView,
    ManufacturingWipCostSummaryAPIView,
    ...
    ManufacturingWorkOrderOperationApproveAPIView,
    ManufacturingWorkOrderOperationCompleteAPIView,
    ManufacturingWorkOrderOperationRejectAPIView,
...
urlpatterns = [
    ...
    path("summary/", ManufacturingSummaryAPIView.as_view(), name="manufacturing-summary"),
    path("reports/material-consumption/", ManufacturingMaterialConsumptionAPIView.as_view(), name="manufacturing-material-consumption"),
    path("reports/output-yield/", ManufacturingOutputYieldAPIView.as_view(), name="manufacturing-output-yield"),
    path("reports/posting-audit/", ManufacturingPostingAuditAPIView.as_view(), name="manufacturing-posting-audit"),
    path("reports/wip-cost-summary/", ManufacturingWipCostSummaryAPIView.as_view(), name="manufacturing-wip-cost-summary"),
    ...
    path("work-orders/<int:pk>/operations/<int:operation_pk>/approve/", ManufacturingWorkOrderOperationApproveAPIView.as_view(), name="manufacturing-work-order-operation-approve"),
    path("work-orders/<int:pk>/operations/<int:operation_pk>/reject/", ManufacturingWorkOrderOperationRejectAPIView.as_view(), name="manufacturing-work-order-operation-reject"),
