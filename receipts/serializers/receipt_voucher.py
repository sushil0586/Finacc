...
class ReceiptVoucherHeaderSerializer(serializers.ModelSerializer):
    ...
    received_in_name = serializers.CharField(source="received_in.accountname", read_only=True)
    received_from_name = serializers.CharField(source="received_from.accountname", read_only=True)
