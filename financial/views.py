  ...
  #  filter_class = accountheadFilter
    ...
    def get(self, request, format=None):
      ...
      #  accountgst = self.request.query_params.get('accountgst')
        ...
        gstdetails = GstAccountsdetails.objects.filter().values('gstin','tradeName','legalName','addrFlno','addrBnm','addrBno','addrSt','addrLoc__id','stateCode__id','stateCode__country__id','addrLoc__distt__id','addrPncd','txpType','status','blkStatus','dtReg','dtDReg')
