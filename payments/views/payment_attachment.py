...
class PaymentVoucherAttachmentListCreateAPIView(PaymentVoucherAttachmentBaseAPIView):
    ...
    def post(self, request, pk: int):
        ...
        for file_obj in files:
            created.append(
                PaymentVoucherAttachment.objects.create(
        ...
        return Response(
            {
                ...
                "data": PaymentVoucherAttachmentSerializer(created, many=True).data,
            },
...
class PaymentVoucherAttachmentDownloadAPIView(PaymentVoucherAttachmentBaseAPIView):
    parser_classes = []
