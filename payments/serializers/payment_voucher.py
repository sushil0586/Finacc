...
class PaymentVoucherHeaderSerializer(serializers.ModelSerializer):
    ...
    paid_from_name = serializers.CharField(source="paid_from.accountname", read_only=True)
    paid_to_name = serializers.CharField(source="paid_to.accountname", read_only=True)
