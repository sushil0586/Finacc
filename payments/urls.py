...
urlpatterns = [
    ...
    path("payment-vouchers/<int:pk>/attachments/", PaymentVoucherAttachmentListCreateAPIView.as_view(), name="payment-voucher-attachments"),
    path("payment-vouchers/<int:pk>/attachments/<int:attachment_id>/", PaymentVoucherAttachmentDeleteAPIView.as_view(), name="payment-voucher-attachment-delete"),
    path("payment-vouchers/<int:pk>/attachments/<int:attachment_id>/download/", PaymentVoucherAttachmentDownloadAPIView.as_view(), name="payment-voucher-attachment-download"),
